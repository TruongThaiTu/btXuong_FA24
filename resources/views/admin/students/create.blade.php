                ...
                <div class="card-body">
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="name" class="form-control" id="name"
                            placeholder="Nhập tên sinh viên" value="{{ old('name') }}" required>
                    </div>

                    <div class="form-group mb-3">
                        <label for="email">Email Sinh Viên</label>
                        <input type="email" name="email" class="form-control" id="email"
                            placeholder="Nhập email sinh viên" value="{{ old('email') }}" required>
                    </div>
                ...
                <div class="card-body">
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="passport_number" class="form-control" id="passport_number"
                            placeholder="Nhập số hộ chiếu" value="{{ old('passport_number') }}" required>
                    </div>
